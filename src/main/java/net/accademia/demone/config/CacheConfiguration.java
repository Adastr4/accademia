...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, net.accademia.demone.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, net.accademia.demone.repository.UserRepository.USERS_BY_EMAIL_CACHE);
