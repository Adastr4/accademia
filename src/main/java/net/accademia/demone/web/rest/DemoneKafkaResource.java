...
@RestController
@RequestMapping("/api/demone-kafka")
public class DemoneKafkaResource {

    private final Logger log = LoggerFactory.getLogger(DemoneKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public DemoneKafkaResource(KafkaProperties kafkaProperties) {
